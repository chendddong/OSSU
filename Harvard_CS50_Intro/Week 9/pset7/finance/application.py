...
def buy():
    ...
    if request.method == "GET":
        return render_template("buy.html", flag=False)
    else:
        # ensure proper symbol
        stock = lookup(request.form.get("symbol"))
        if not stock:
            return apology("Kindle says: Invalid Symbol")
        
        # ensure proper number of shares
        try:
            shares = int(request.form.get("shares"))
            if shares < 0:
                return apology("Kindle says: Shares must be positive integer")
        except:
            return apology("Kindle says: Shares must be positive integer")
        ...
        if not money or float(money[0]["cash"]) < stock["price"] * shares:
            return apology("Kindle says: Not enough money")
...
def login():
    ...
    if request.method == "POST":
        ...
        if not request.form.get("username"):
            return apology("Kindle says: Must provide username")

        # ensure password was submitted
        elif not request.form.get("password"):
            return apology("Kindle says: Must provide password")
        ...
        if len(rows) != 1 or not pwd_context.verify(request.form.get("password"), rows[0]["hash"]):
            return apology("Kindle says: invalid username and/or password")
...
def register():
    ...
    if request.method == "POST":
        ...
        if not result:
            return apology("Kindle says: Username already exist")
...
def sell():
    ...
    if request.method == "GET":
        ...
        if not user_shares or int(user_shares[0]["shares"]) < shares:
            return apology("Kindle says: Not enough shares")
        
        # update history of a sell and mind the -shares since it's selling the stock
        db.execute("INSERT INTO histories (symbol, shares, price, id) \
                    VALUES(:symbol, :shares, :price, :id)", \
                    symbol=stock["symbol"], shares=-shares, \
                    price=usd(stock["price"]), id=session["user_id"])
...
def loan():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if loan < 0:
                return apology("Kindle says: Loan must be positive amount")
            elif loan > 1000:
                return apology("Kindle says: Cannot loan more than $1,000 at once")
        except:
            return apology("Kindle says: Loan must be positive integer")
        ...
        # return to index
        return apology("Kindle says: Loan is successful", "No need to pay me back")

...
// 1.   the first (f) must be a floating-point value in (0.0, 100.0],

// 2.   the second must be the name of a BMP to be resized, and

// 3.   the third must be the name of the resized version to be written.

// + If your program is not executed with such, it should remind the user of correct usage, 
// as with fprintf (to stderr), and main should return 1.
...
/*
    ...
    parses int input
    opens a file
    updats header info for outfile
